...
import NoteModal from '../../../patients_tab/selected_patient_tab/info_components/NoteModal';
...
function NotesList({ selectedPatient }) {
  ...
  // Title options for dropdown selection (similar to medicine/HC components)
  const titleOptions = [
